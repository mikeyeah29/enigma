...
class Header_Customizer {
    ...
    private static function register_header_colors($wp_customize) {
        ...
        // Header Contact Bar
        $wp_customize->add_setting('header_contact_bg_color', array(
            'default'   => '',
            'transport' => 'refresh',
        ));

        $wp_customize->add_control('header_contact_bg_color', array(
            'label'    => __('Header Contact Bar Background Color', 'rwd-enigma'),
            'section'  => 'header_options',
        ...
        // Header Contact Text Color Setting
        $wp_customize->add_setting('header_contact_text_color', array(
            'default'   => '',
            'transport' => 'refresh',
        ));

        $wp_customize->add_control('header_contact_text_color', array(
            'label'    => __('Header Contact Bar Text Color', 'rwd-enigma'),
            'section'  => 'header_options',
