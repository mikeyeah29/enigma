...
var map = {
	"./cta-section/style.scss": "./blocks/cta-section/style.scss",
	"./feature-card/style.scss": "./blocks/feature-card/style.scss",
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function setCookie(name, value, days) {
    ...
    var cookieValue = name + '=' + value + '; expires=' + expires.toUTCString() + '; path=/; SameSite=Lax';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  testimonialSliders.forEach(el => {
    ...
    const slider = new blaze_slider__WEBPACK_IMPORTED_MODULE_1__["default"](el, {
      all: {
        slidesToShow: 1,
        loop: true,
